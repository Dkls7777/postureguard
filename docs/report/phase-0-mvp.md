# Phase 0: MVP and local production basics

Building the application end to end on a local machine: authentication, DNS ownership
verification, three scanners, scoring, and Linux production basics.
